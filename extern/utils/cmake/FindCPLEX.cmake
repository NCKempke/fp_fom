...
#
# Users need to set/overwrite CPLEXDIR and possibly overwrite CPLEX_LIBFORMAT
...
find_path(CPLEX_INCLUDE_DIR "ilcplex/cplex.h" PATHS ${CPLEXDIR}/include)
find_library(CPLEX_LIBRARY "libcplex.a" PATHS ${CPLEXDIR}/lib/${CPLEX_LIBFORMAT} ${CPLEXDIR}/lib)
